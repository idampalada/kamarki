...
Route::group(['namespace' => 'Botble\RealEstate\Http\Controllers', 'middleware' => ['web', 'core']], function () {
            ...
            Route::group(['as' => 'public.account.'], function () {
                Route::group(['middleware' => ['account.guest']], function () {
                    ...
                    Route::post('register', 'RegisterController@register')
                        ->name('register.post');
                    // Route::get('otp/verify/{id}', 'RegisterController@otpvarify')
                    // ->name('otp.verify');
    ...
    Route::post('otplogin', 'RegisterController@otp_login')
        ->name('otplogin');
    Route::get('verifyotp', 'RegisterController@verifyotp')->name('verifyotp');
    Route::post('opt/resend', 'RegisterController@otpresend')->name('opt.resend');
});
